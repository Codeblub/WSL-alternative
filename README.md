...
## 1. [Currently working on and changelogs](https://github.com/Codeblub/WSL-alternative/blob/main/README.md#currently-working-on)
...
2. Execute: Run run.bat and wait for the system to boot.
   ...
   Note: It might take 1-4 mins depending on you hardware
